Windows バイナリパッケージ of Julius-4.1.3
===========================================

このパッケージについて
=======================

これは Julius-4.1.3 の Windows用実行バイナリ配布パッケージです．
Julius Rev.4.1.3 の Windows 用実行バイナリおよびライブラリが含まれています．
Windows のコンソールモードで動作します．

動作を試すには，ディクテーションキットなどのJulius実行キットを入手して，
実行バイナリをこのアーカイブのものに差し替えればOKです．
最新情報は，Julius の Web ページもご覧ください．
...
コンパイルは Windows Vista + MinGW (5.1.0) で行いました．
...
同梱の以下の文書をご覧ください．
    ...
    00readme-julius-ja.txt  Julius-4.1.2 readme
    LICENSE.txt		    利用許諾
