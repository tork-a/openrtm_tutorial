Windows binary package of Julius-4.1.3
=======================================

This archive contains Win32 binaries and documents of Julius rev. 4.1.3.
To know about this release, see "00readme-julius.txt" and "Release.txt".

From 4.1.3, Julius also can be compiled with Microsoft Visual C++ 2008.
Please download the source archive (julius-x.x.x.tar.gz), unpack and
see "msvc/00README.txt" for details.
...
The binaries are compiled on MinGW-5.1.0 on Windows Vista, not MSVC.
