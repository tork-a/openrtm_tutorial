...
call ..\Apps\rtshell\rtcon 127.0.0.1/%HOSTNAME%.host_cxt/Skelton2JointAngle0.rtc:joint_angle 127.0.0.1/%HOSTNAME%.host_cxt/Cnoid_RobotMotion0.rtc:targetAngle
