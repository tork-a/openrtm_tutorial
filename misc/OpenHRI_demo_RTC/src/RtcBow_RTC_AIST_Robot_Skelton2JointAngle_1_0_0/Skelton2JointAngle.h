...
#ifndef __RTC_SKELTON2JOINTANGLE_H__
#define __RTC_SKELTON2JOINTANGLE_H__
  ...
  : public RTC::DataFlowComponentBase
{
 public:
   ...
   */
  Skelton2JointAngle(RTC::Manager* manager);
 ...
 protected:
  ...
  // <rtc-template block="outport_declare">
   RTC::TimedDoubleSeq m_joint_angle;
   OutPort<RTC::TimedDoubleSeq> m_joint_angleOut;
...
extern "C"
{
  DLL_EXPORT void Skelton2JointAngleInit(RTC::Manager* manager);
};

#endif // __RTC_SKELTON2JOINTANGLE_H__
