...
if exist "%VC10_DIR%\Common7\IDE\VCExpress.exe" "%VC10_DIR%\Common7\IDE\VCExpress.exe" Skelton2JointAngle.sln /Build Release
if exist "%VC10_DIR%\Common7\IDE\devenv.com" "%VC10_DIR%\Common7\IDE\devenv.com" Skelton2JointAngle.sln /Build Release
