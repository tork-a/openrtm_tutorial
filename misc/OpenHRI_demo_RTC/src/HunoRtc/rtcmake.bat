...
if exist "%VC10_DIR%\Common7\IDE\VCExpress.exe" "%VC10_DIR%\Common7\IDE\VCExpress.exe" %PROJECT%.sln /Build Release
if exist "%VC10_DIR%\Common7\IDE\devenv.com" "%VC10_DIR%\Common7\IDE\devenv.com" %PROJECT%.sln /Build Release

mkdir ..\rtc
copy src\Release\* ..\rtc\*
cd ..
copy .\*.conf .\rtc
