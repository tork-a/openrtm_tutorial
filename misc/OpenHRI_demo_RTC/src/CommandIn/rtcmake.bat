...
if exist "%VC10_DIR%\Common7\IDE\VCExpress.exe" "%VC10_DIR%\Common7\IDE\VCExpress.exe" %PROJECT_NAME%.sln /Build Release
if exist "%VC10_DIR%\Common7\IDE\devenv.com" "%VC10_DIR%\Common7\IDE\devenv.com"  %PROJECT_NAME%.sln /Build Release
