...
if exist "%VC10_DIR%\Common7\IDE\VCExpress.exe" "%VC10_DIR%\Common7\IDE\VCExpress.exe" SimpleGesture.sln /Build Release
if exist "%VC10_DIR%\Common7\IDE\devenv.com" "%VC10_DIR%\Common7\IDE\devenv.com" SimpleGesture.sln /Build Release
