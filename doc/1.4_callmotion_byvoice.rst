...
.. raw:: html
    ...
    <ul>
     <li><a class="reference external"  href="javascript:void(0)" onclick="call_rtmnamerserver(); return false;">CORBA Nameserver (rtm-naming.bat)</a></li>
     <li><a class="reference external"  href="javascript:void(0)" onclick="call_rtseditor(); return false;">./demo/RTSE.bat</a></li>
    </ul>
...
Go back to `index <top.html>`__ | Go to `next <1.5_modifystate_seatsat.html>`__ |
